  ...
  return (
    <section className="mx-auto my-8 rounded-2xl border border-white/80 bg-white/85 px-5 py-5 font-sans shadow-[0_14px_35px_rgba(4,25,47,0.07)] backdrop-blur sm:px-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
        <img
          src="/media/clement-rondepierre-fondateur-jobmi.jpg"
          alt="Clément Rondepierre, fondateur de Jobmi"
          width={64}
          height={64}
          className="h-16 w-16 shrink-0 rounded-full object-cover shadow-[0_12px_24px_rgba(101,0,255,0.25)]"
        />
        <div>
