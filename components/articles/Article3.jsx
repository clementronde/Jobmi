  ...
  return (
    <div className='sm:mx-5 mx-1'>
      ...
      <div className='font-sans my-10 sm:py-20 py-2 mx-auto max-w-[700px] relative overflow-visible'>
        <img className='absolute top-0 right-0 w-14 translate-x-4 sm:translate-x-0 pointer-events-none' src="/media/arrow-blog-h2.svg" alt="" aria-hidden="true" />
        <h2 className='text-4xl font-bold text-center uppercase pr-10'>
      ...
      <div className='font-sans my-10 sm:mx-20 p-5 flex flex-col gap-5'>
        ...
        <div className='space-y-4'>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Compétences requises :</h3>
            <p>Programmation, créativité, compréhension des moteurs de jeu comme Unity ou Unreal Engine.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Pourquoi c'est cool ?</h3>
            <p>Travailler à la pointe de la technologie, créer des mondes virtuels immersifs et collaborer avec des équipes créatives.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Tu veux en savoir plus ?</h3>
            <p>Découvrez les formations pour devenir développeur VR sur jobmi</p>
          </div>
        </div>
      </div>
      ...
      <div className='font-sans my-10 sm:mx-20 p-5 flex flex-col gap-5'>
        ...
        <div className='space-y-4'>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Compétences requises :</h3>
            <p>Connaissance des réseaux, analyse des risques, compétences en cryptographie.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Pourquoi c'est intéressant ?</h3>
            <p>Travail essentiel pour la sécurité des données, défi intellectuel constant, possibilité de travailler pour des entreprises high-tech.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Tu veux en savoir plus ?</h3>
            <p>Découvres toutes les informations sur la cybersécurité</p>
          </div>
        </div>
      </div>
      ...
      <div className='font-sans my-10 sm:mx-20 p-5 flex flex-col gap-5'>
        ...
        <div className='space-y-4'>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Compétences requises :</h3>
            <p>Ingénierie, connaissance des énergies renouvelables, compétences en gestion de projet.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>En quoi c'est utile ?</h3>
            <p>Contribuer à la protection de l'environnement, travailler sur des projets innovants, forte demande de compétences.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Tu veux en savoir plus ?</h3>
            <p>Découvrez les formations pour devenir ingénieur en énergie renouvelable</p>
          </div>
        </div>
      </div>
      ...
      <div className='font-sans my-10 sm:mx-20 p-5 flex flex-col gap-5'>
        ...
        <div className='space-y-4'>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Compétences requises :</h3>
            <p>Design graphique, psychologie de l'utilisateur, compétences en prototypage.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Pourquoi c'est top ?</h3>
            <p>Mélange de créativité et de technologie, impact direct sur l'expérience utilisateur, forte demande dans le secteur tech.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Tu veux en savoir plus ?</h3>
            <p>Découvrez les formations en UX/UI design sur jobmi</p>
          </div>
        </div>
      </div>
      ...
      <div className='font-sans my-10 sm:mx-20 p-5 flex flex-col gap-5'>
        ...
        <div className='space-y-4'>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Compétences requises :</h3>
            <p>Statistiques, programmation (Python, R), compétences en visualisation de données.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Pourquoi c'est cool ?</h3>
            <p>Travail analytique stimulant, forte demande dans tous les secteurs, possibilité de travailler sur des projets diversifiés.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Tu veux en savoir plus ?</h3>
            <p>Découvrez comment devenir data scientist</p>
          </div>
        </div>
      </div>

      {/* 6. Spécialiste en IA — pas d'image */}
      <div className='font-sans my-10 sm:mx-20 p-5 flex flex-col gap-5'>
        <h2 className='text-3xl sm:text-left text-center font-bold uppercase'>
        ...
        <div className='space-y-4'>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Compétences requises :</h3>
            <p>Programmation, machine learning, analyse de données.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>En quoi c'est intéressant ?</h3>
            <p>Travail à la pointe de l'innovation technologique, possibilité de changer le monde, forte demande de compétences.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Tu veux en savoir plus ?</h3>
            <p>Découvres toutes les informations sur les formations en intelligences artificielles</p>
          </div>
        </div>
      </div>
      ...
      <div className='font-sans my-10 sm:mx-20 p-5 flex flex-col gap-5'>
        ...
        <div className='space-y-4'>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Compétences requises :</h3>
            <p>Gestion de projet, connaissance des pratiques durables, compétences en communication.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Pourquoi c'est utile ?</h3>
            <p>Contribuer à la protection de l'environnement, impact positif sur la société, travail diversifié.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Tu veux en savoir plus ?</h3>
            <p>En savoir plus sur les métiers du développement durable.</p>
          </div>
        </div>
      </div>
      ...
      <div className='font-sans my-10 sm:mx-20 p-5 flex flex-col gap-5'>
        ...
        <div className='space-y-4'>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Compétences requises :</h3>
            <p>Ingénierie mécanique, programmation, conception de systèmes.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Pourquoi c'est top ?</h3>
            <p>Travailler sur des projets futuristes, forte demande dans de nombreux secteurs, opportunités d'innovation.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Tu veux en savoir plus ?</h3>
            <p>Découvres les formations en ingénieur robotique.</p>
          </div>
        </div>
      </div>

      {/* 9. Consultant en Transformation Numérique — pas d'image */}
      <div className='font-sans my-10 sm:mx-20 p-5 flex flex-col gap-5'>
        <h2 className='text-3xl sm:text-left text-center font-bold uppercase'>
        ...
        <div className='space-y-4'>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Compétences requises :</h3>
            <p>Connaissance des technologies numériques, gestion de projet, compétences en communication.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>En quoi c'est utile ?</h3>
            <p>Travail diversifié, possibilité d'influencer le changement organisationnel, forte demande dans tous les secteurs.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Tu veux en savoir plus ?</h3>
            <p>Découvrez comment devenir consultant en transformation numérique.</p>
          </div>
        </div>
      </div>

      {/* 10. Coach en Développement Personnel — pas d'image */}
      <div className='font-sans my-10 sm:mx-20 p-5 flex flex-col gap-5'>
        <h2 className='text-3xl sm:text-left text-center font-bold uppercase'>
          10. Coach en Développement Personnel
        </h2>
        <p>
          Le coach en développement personnel accompagne ses clients pour les aider à atteindre leurs objectifs personnels et professionnels. Il utilise des techniques de coaching, de pleine conscience et de psychologie positive pour favoriser la croissance et l'épanouissement. Ce professionnel doit posséder une forte empathie, d'excellentes compétences en communication et une écoute active. Il travaille souvent en indépendant ou au sein de cabinets spécialisés. Son rôle est d'aider chaque personne à libérer son plein potentiel.
        </p>
        <div className='space-y-4'>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Compétences requises :</h3>
            <p>Psychologie, compétences en communication, empathie</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Pourquoi c'est top ?</h3>
            <p>Aider les gens à atteindre leur potentiel, flexibilité du travail, forte demande de services de coaching.</p>
          </div>
          <div className='bg-gray-100 p-4 rounded-lg'>
            <h3 className='font-bold'>Tu veux en savoir plus ?</h3>
            <p>En savoir plus sur le coaching en développement personnel</p>
          </div>
        </div>
      </div>
